...
export function Card({ card, location, isSelected, isHighlighted, onClick, onInfoClick, className, isInteractable = true, disableLift = false }: CardProps) {
  ...
  if (card.type === CARD_TYPES.TACTIC) {
    ...
    return (
      ...
      >
        <PhantomEffect isActive={isHighlighted && !isSelected} />
